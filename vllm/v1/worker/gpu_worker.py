...
class Worker(WorkerBase):
    ...
    def execute_model(
        ...
        # Non-blocking send of the intermediate tensors. The metadata list
        # already went out synchronously inside isend_tensor_dict, so every
        # returned handle is a device tensor send; they are waited before the
        # next step's receive.
