...
class DeepseekV4SWACache(torch.nn.Module, AttentionLayerBase):
    ...
    def get_kv_cache_spec(self, vllm_config: VllmConfig) -> KVCacheSpec:
        ...
        return SlidingWindowMLASpec(
            ...
            # DeepseekV4 fp8_ds_mla: 584B per token (448B NoPE + 128B RoPE + 8B
            # scales). int8_ds_mla: 512B signed-int8 row + fp32 row scale + 12B
            # pad = 528B per token.
            state_content_bytes=584
            if uses_fp8_ds_mla_layout
            else (528 if uses_int8_ds_mla_layout else None),
            # 576B for FlashMLA packing; 528B for our int8_ds_mla packed
            # layout; 512B for FlashInfer sparse (#44577) otherwise.
            alignment=576
            if uses_fp8_ds_mla_layout
