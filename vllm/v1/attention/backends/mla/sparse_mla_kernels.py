...
def sparse_mla_decode_head_block_size(num_decode_tokens: int) -> int:
    ...
    # Capability-based heuristic (no env override): single-token decode is
    # latency-bound and wants one head per program; larger batches amortize the
    # dequantized KV row across grouped heads.
