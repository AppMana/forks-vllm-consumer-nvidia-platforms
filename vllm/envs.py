...
if TYPE_CHECKING:
    ...
    VLLM_DEEPSEEK_V4_INDEXED_D512_FUSED_SINK_PREFILL: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    "VLLM_DEEPSEEK_V4_INDEXED_D512_FUSED_SINK_PREFILL": lambda: bool(
        int(os.getenv("VLLM_DEEPSEEK_V4_INDEXED_D512_FUSED_SINK_PREFILL", "0"))
    ),
