...
def main() -> int:
    ...
    parser.add_argument(
        "--model", default="/home/administrator/Documents/dsv4-debug/ckpt"
    )
    ...
    for round_idx in range(args.rounds):
        ...
        outputs = llm.generate(round_prompts if round_idx else prompts, params)
        print(f"DSV4_INT8KV_REPRO_ROUND_OK {round_idx}", flush=True)
